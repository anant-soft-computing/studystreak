...
class PasswordResetSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        if User.objects.filter(email=email).exists():
            ...
            context = {'link': link}
            html_message = render_to_string("emails/forgot-password.html", context=context)
...
class RedirectLinkSerializer(serializers.Serializer):
  ...
  password = serializers.CharField(max_length=55, style={'input_type':'password'},validators=[validate_password], write_only=True)
  password2 = serializers.CharField(max_length=55, style={'input_type':'password'},validators=[validate_password], write_only=True)
